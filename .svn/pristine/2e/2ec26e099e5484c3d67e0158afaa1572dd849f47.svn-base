      ...
      <!-- Main -->
         ...
         <div class="mainBox" style="padding-top: 3.5em;">
            ...
            <ul class="actions small">
               ...
               <a href="${pageContext.request.contextPath}/admin/admin/AdminNoticeListOk.ad"><p id="inform" class="s-title bGray" >공지</p></a>
			</div>
...
<table>
				<form action="${pageContext.request.contextPath}/admin/AdminNoticeInsert.ad" method="post" name="writeForm">
