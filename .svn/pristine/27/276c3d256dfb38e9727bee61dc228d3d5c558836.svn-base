...
public class CommunityListOk implements Action{
	@Override
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		HashMap<String, Integer> communityMap = new HashMap<>();
...
//		MemberDAO mDao = new MemberDAO();
		...
		communityMap.put("startRow", startRow);
		communityMap.put("rowCount", rowCount);
...
//		req.setAttribute("boardList", boardDTO_list);
		...
		af.setPath("/app/community/community2.jsp");
