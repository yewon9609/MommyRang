...
<aside class="aside" style="width: 150px;
					left: 93%;
						top: 88% !important;
						cursor:pointer;
               position: fixed;">
...
<aside class="aside" id = "chatAside" style="width: 150px;
        ...
        <div id="divToggle" style="display: none; "><iframe src = "${pageContext.request.contextPath}/app/chat/chatLog.jsp" width= "400px !important" height="600px !important" 
        	style = "position:absolute; left:-300px; top: -595px; border-radius:10px; box-shadow: 4px 4px 20px rgb(51 51 51 / 15%); z-index:20;"></iframe>
        </div>
...
<!-- 채팅 -->
<aside class="aside" id = "chatAside2" style="width: 150px;
					left: 92.7%;
						/*-- top: 80% !important; */
						top: 79% !important;
						cursor:pointer;
         ...
         <div id="divToggle2" style="display: none; "><iframe src = "${pageContext.request.contextPath}/app/chat/chatNew.jsp" width= "400px !important" height="715px !important" 
        	style = "position:absolute; left:-300px; top: -655px; border-radius:10px; box-shadow: 4px 4px 20px rgb(51 51 51 / 15%); z-index:20;"></iframe>
        </div>
